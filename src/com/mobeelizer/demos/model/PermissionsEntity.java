...
/**
 * {@link MobeelizerDatabase} data mapping object used in permissions example.
 * 
 * @see OverlayedEntity
 * @see Comparator
 */
public class PermissionsEntity extends OverlayedEntity implements Comparator<PermissionsEntity> {
    ...
    public boolean equals(final Object obj) {
        ...
        PermissionsEntity other = (PermissionsEntity) obj;
        if (guid == null) {
            if (other.guid != null) {
                return false;
            }
