...
/**
 * A concrete BaseAdapter that is backed by an array of arbitrary objects. By default this class expects that the provided
 * resource id references a single TextView. If you want to use a more complex layout, use the constructors that also takes a
 * field id. That field id should reference a TextView in the larger layout resource.
 * 
 * <p>
 * However the TextView is referenced, it will be filled with the toString() of each object in the array. You can add lists or
 * arrays of custom objects. Override the toString() method of your objects to determine what text will be displayed for the item
 * in the list.
 * 
 * <p>
 * To use something other than TextViews for the array display, for instance, ImageViews, or to have some of data besides
 * toString() results fill the views, override {@link #getView(int, View, ViewGroup)} to return the type of view you want.
 * 
 * <br/>
 * <br/>
 * <b> The only deference to the original implementation are:<br/>
 * - class name prefix (My)<br/>
 * - {@link #getItems()} method </b>
 * 
 */
public class MyArrayAdapter<T> extends BaseAdapter implements Filterable {
     ...
     * this lock. This lock is also used by the filter (see {@link #getFilter()} to make a synchronized copy of the original array
     * of data.
     */
    ...
    /**
     * If the inflated resource is not a TextView, {@link #mFieldId} is used to find a TextView inside the inflated views
     * hierarchy. This field must contain the identifier that matches the one defined in the resource file.
     */
     ...
     */
    public MyArrayAdapter(final Context context, final int resource, final int textViewResourceId) {
     ...
     */
    public MyArrayAdapter(final Context context, final int textViewResourceId, final T[] objects) {
     ...
     *            The objects to represent in the ListView.
     */
    public MyArrayAdapter(final Context context, final int resource, final int textViewResourceId, final T[] objects) {
     ...
     *            The objects to represent in the ListView.
     */
    public MyArrayAdapter(final Context context, final int textViewResourceId, final List<T> objects) {
     ...
     *            The objects to represent in the ListView.
     */
    public MyArrayAdapter(final Context context, final int resource, final int textViewResourceId, final List<T> objects) {
    ...
    /**
     * Returns the list of the items in the array.
     * 
    ...
    private View createViewFromResource(final int position, final View convertView, final ViewGroup parent, final int resource) {
        View view;
        TextView text;
     ...
     */
    public static ArrayAdapter<CharSequence> createFromResource(final Context context, final int textArrayResId,
            final int textViewResId) {
